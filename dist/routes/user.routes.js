...
userRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name_1, email, cellphone, password, createUser, nameLowerCased, emailLowerCased, user, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = request.body, name_1 = _a.name, email = _a.email, cellphone = _a.cellphone, password = _a.password;
