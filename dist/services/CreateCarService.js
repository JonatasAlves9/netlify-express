...
var createCarService = /** @class */ (function () {
    function createCarService() {
    }
    createCarService.prototype.execute = function (_a) {
        var name = _a.name, brand = _a.brand, km = _a.km, year = _a.year, description = _a.description, gearbox = _a.gearbox, price = _a.price, url_master = _a.url_master;
